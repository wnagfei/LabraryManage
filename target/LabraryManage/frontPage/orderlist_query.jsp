...
<link  rel="stylesheet" type="text/css" href="http://localhost:8080/css/page.css" />
    ...
    <script>
        function query() {
            window.location.href="/teacher/order/query/" + $("#qName").val();
        }
    </script>
</head>
    ...
    <th    align="center">状态</th>
	 <th  align="center">操作</th>
        ...
        <tr>
            ...
            <td align="left"><a href="localhost:8080/payforMaterial/${list.id}">赔偿</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="localhost:8080/order/pay/${list.id}">归还</a></td>
        </tr>
</table>
