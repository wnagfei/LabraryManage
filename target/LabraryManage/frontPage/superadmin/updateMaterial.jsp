...
<tr>
  ...
  <tr>
    ...
    <td  width="169" align="left"><input type="text" id="mateNo" name="username" value="${info.materialNo}" /></td>
     <td width="106" align="right">*耗材名称：</td>
     <td width="169" align="left"><input type="text" id="mateName" name="username" value="${info.materialName}" /></td>
  </tr>
  <tr>
  ...
  <tr >
    ...
    <td align="left"><input type="text" id="mateStatus" name="email" value="${info.status}" /></td>
    <td align="right">预约人员：</td>
    <td align="left"><input type="text" id="matePeople" name="remark" value="${info.materialOrder}" /></td>
  </tr>
    <tr>
    <td width="85" align="right">*耗材存放地址：</td>
    <td colspan="2" align="left"><input id="mateAddress" type="text" name="username" value="${info.materialAdress}" /></td>
  </tr>
</table>
...
<script language="javascript">
    function MsgBox()
    {
        $.ajax({
            type:'POST',
            url:'/admin/updateMaterial/submit',
            data:{
                "mateNo":$("#mateNo").val(),
